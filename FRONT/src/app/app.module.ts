...
import { ComputadorReadComponent } from './components/computador/computador-read/computador-read.component';
import { ComputadorRead2Component } from './components/computador/computador-read2/computador-read2.component';
...
@NgModule({
  declarations: [
    ...
    FooterComponent,
    HomeComponent,
    ComputadorCrudComponent,
    ComputadorCreateComponent,
    ComputadorReadComponent,
    ComputadorRead2Component,
    ComputadorDeleteComponent
